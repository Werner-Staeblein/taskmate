...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'wernerstaskmate.up.railway.app'
]


CSRF_TRUSTED_ORIGINS = [
     'https://wernerstaskmate.up.railway.app']
...
INSTALLED_APPS = [
    ...
    # Hier registriert weil INSTALLED_APPS in Reiheinfolge geladen wird und crispy
    # geladen sein muss bevor es in users_app benutzt wird
    'crispy_forms',  
    'crispy_bootstrap5',
